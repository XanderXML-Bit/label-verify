# Benchmark Run — 2026-05-12T08:14:50.786Z

Mode: `full`. Corpus: `C:\Users\xande\OneDrive\Desktop\Zendren LLC\LabelVerify\test-data-combined` (140 images). Trials per image: 1.

## Overall accuracy (Wilson 95% CI)

| Technique | Acc | Gov-Warning FN-rate | Latency P50 / P95 (ms) | Failures |
|-----------|-----|---------------------|------------------------|----------|
| T6 | 93.3% (n=973) [91.6, 94.7] | 6.4% (n=109) [3.1, 12.7] | 2382 / 3316 | 1 |
...
|-----------|---------------|----------------|------------|------------------|----------|-----------|
| T6 | 1701 | 404 | $0.00025 | $0.25 | 3749.22 | 0.369 |
...
|-----------|-----|--------------------|------------------|
| **T6** | 93.3% (n=973) [91.6, 94.7] | 2530 | $0.25 |
