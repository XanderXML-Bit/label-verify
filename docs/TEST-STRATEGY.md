...
|---|---:|---|---|
| Vitest specs (unit + integration) | 857 across 81 files | ~10 s (`npm test`) | Pipeline correctness: matchers, validators, scorers, route handlers, schemas, CLI argument parsing. |
