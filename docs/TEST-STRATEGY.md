...
|---|---:|---|---|
| Vitest specs (unit + integration) | 948 across 90 files | ~10 s (`npm test`) | Pipeline correctness: matchers, validators, scorers, route handlers, schemas, CLI argument parsing. |
