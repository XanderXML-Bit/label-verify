...
|---|---:|---|---|
| Vitest specs (unit + integration) | 887 across 85 files | ~10 s (`npm test`) | Pipeline correctness: matchers, validators, scorers, route handlers, schemas, CLI argument parsing. |
