...
|---|---:|---|---|
| Vitest specs (unit + integration) | 944 across 89 files | ~10 s (`npm test`) | Pipeline correctness: matchers, validators, scorers, route handlers, schemas, CLI argument parsing. |
